      ...
      <div className="w-[800px] bg-white rounded-lg p-6 mt-10">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className='flex gap-[32px]'>
            ...
            <button
              type="button"
              className="w-full bg-red-500 text-white py-2 px-4 rounded-md text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
